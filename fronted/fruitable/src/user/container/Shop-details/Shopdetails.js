...
import { AddcartSlice, Decrement_cart, Icrement_cart } from '../../../redux/reducer/slice/cart.silce';
...
function Shopdetails(props) {
    ...
    //     getdata()
    // }, [])
    const fruite_detail = useSelector(state => state.shop)
    // console.log(fruite_detail);
    ...
    useEffect(() => {
        dispatch(getReview())
        const data = fruite_detail.shop.find((v) => v.id === id)
        // console.log(data);
        setfruitedetails(data)
    }, [])

    const addcart = () => {
        dispatch(AddcartSlice({ id, count }))
    }
                                    ...
                                    <div className="input-group quantity mb-5" style={{ width: 100 }}>
                                        <div className="input-group-btn">
                                            <button className="btn btn-sm btn-minus rounded-circle bg-light border">
                                                <i className="fa fa-minus" onClick={hendelDecrement} />
                                            </button>
                                        </div>
                                        <span className="form-control form-control-sm text-center border-0">{count}</span>
                                        <div className="input-group-btn">
                                            <button className="btn btn-sm btn-plus rounded-circle bg-light border">
                                                <i className="fa fa-plus" onClick={hendelIncrement} />
                                            </button>
                                        </div>
                                    </div>
                                    <button onClick={addcart} className="btn border border-secondary rounded-pill px-4 py-2 mb-4 text-primary"><i className="fa fa-shopping-bag me-2 text-primary" /> Add to cart</button>
                                </div>
                                    ...
                                    <div className="tab-content mb-5">
                                        ...
                                        <div className="tab-pane" id="nav-mission" role="tabpanel" aria-labelledby="nav-mission-tab">
                                            <div className="d-flex">
                                                <img src="
                                                img/avatar.jpg" className="img-fluid rounded-circle p-3" style={{ width: 100, height: 100 }} alt />
                                                <div className>
