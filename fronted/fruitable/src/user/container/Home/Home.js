...
function Home(props) {
    ...
    return (
        <div >
            {/* Hero Start */}
            <div className={`container-fluid py-5 mb-5  ${themeContext.theme === 'light' ? "hero-header" : null}`}>
                ...
                <div className="container py-5">
                    ...
                    <div className="row g-4">
                        <div className="col-lg-6 col-xl-4">
                            {/* <div className={`p-4 rounded bg-light ${themeContext.theme}`}> */}
                            <div className={`p-4 rounded ${themeContext.theme === "dark"
            ...
            <div className={`container-fluid py-5 `}>
                <div className="container">
                    <div className={`bg-light p-5 rounded ${themeContext.theme}`}>
                        <div className={`row g-4 justify-content-center ${themeContext.theme}`}>
                            <div className={`col-md-6 col-lg-6 col-xl-3`}>
                                <div className={`counter bg-white rounded p-5 ${themeContext.theme}`}>
            ...
            <div className="container-fluid testimonial py-5">
                <div className="container py-5">
                    ...
                    <OwlCarousel {...testimonialOption} className="owl-carousel testimonial-carousel">
                        <div className={`testimonial-item img-border-radius bg-light rounded p-4 ${themeContext.theme === 'dark' ? "bg-light" : null}`}>
                            <div className="position-relative">
