...
const AdminLinks = [
    ...
    { title: 'Facilities', icon: <AddBusinessIcon />, to: '/admin/Facilities' },
    { title: 'Shop', icon: <AddBusinessIcon />, to: '/admin/Shop' },
    ...
    { title: 'Salespeople', icon: <LoyaltyIcon />, to: "/admin/Salespeople" },
]
